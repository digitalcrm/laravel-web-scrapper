<div>
    ...
    <form wire:submit.prevent="fetch">
        ...
        <button  wire:loading.attr="disabled" class="btn btn-primary float-end" type="submit">
            <span wire:loading wire:target="fetch" class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
            <span wire:loading.class="visually-hidden" wire:target="fetch">Submit</span>
            <span wire:loading.class.remove="visually-hidden" wire:target="fetch" class="visually-hidden">fetching...</span>
        </button>
    </form>
